...
import net.eletroseg.iadecclouvor.modelo.Harpa;
...
public class AdapterListaHarpa extends RecyclerView.Adapter<AdapterListaHarpa.ViewHolder> {

    private Context ctx;
    String pesquisa = "";
    //Itens de exibição / filtrados
    private List<Harpa> itens_exibicao;
    //Essa lista contem todos os itens.
    private List<Harpa> itens;
    ...
    public AdapterListaHarpa(Context mContext, List<Harpa> items) {
        this.ctx = mContext;
        this.itens = items;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final Harpa hino = itens_exibicao.get(position);

        // displaying text view data
        holder.nome.setText(hino.nome);
        holder.cantor.setText(hino.letra);
        holder.tomM.setText(hino.numero);
...
if (verificarNaMemoria(hino.nome)){
   ...
   // Toast.makeText(ctx, "ok ok ", Toast.LENGTH_SHORT).show();
    ...
    public Harpa getItem(int position) {
    ...
    public interface OnClickListener {
        void onItemClick(View view, Harpa obj, int pos);

        void onItemLongClick(View view, Harpa obj, int pos);
    }
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                itens_exibicao = (List<Harpa>) results.values; // Valores filtrados.
