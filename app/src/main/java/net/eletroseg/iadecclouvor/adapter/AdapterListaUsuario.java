...
public class AdapterListaUsuario extends RecyclerView.Adapter<AdapterListaUsuario.ViewHolder> {
    ...
    public AdapterListaUsuario(Context mContext, List<Usuario> items) {
        this.ctx = mContext;
        this.itens = items;
