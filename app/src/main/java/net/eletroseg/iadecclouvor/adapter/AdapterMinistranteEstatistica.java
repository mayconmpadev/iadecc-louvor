...
public class AdapterMinistranteEstatistica extends RecyclerView.Adapter<AdapterMinistranteEstatistica.ViewHolder> {
    ...
    public AdapterMinistranteEstatistica(Context mContext, List<FiltroCron> items, OnClickListener onClickListener) {
        this.ctx = mContext;
        this.itens = items;
        this.onClickListener = onClickListener;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        DatabaseReference reference = database.getReference().child(Constantes.USUARIOS).child(filtroCron.id);
