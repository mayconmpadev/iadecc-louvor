...
import net.eletroseg.iadecclouvor.adapter.AdapterMinistranteEstatistica;
...
public class InstrumentalEstatisticaActivity extends AppCompatActivity implements AdapterMinistranteEstatistica.OnClickListener {
    ...
    private AdapterMinistranteEstatistica mAdapter;
    String sPesquisa = "";
    String caminho = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instrumental_estatistica);
        ...
        mAdapter = new AdapterMinistranteEstatistica(this, filtroCrons, this);
    ...
    private void buscarClienteWeb(String cominho) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < arrayListUsuario.size(); i++) {
                    for (int j = 0; j < arrayListUsuario.get(i).instrumental.size(); j++) {
                        if (!arrayListNome.contains(arrayListUsuario.get(i).instrumental.get(j).id)) {
                            arrayListNome.add(arrayListUsuario.get(i).instrumental.get(j).id);
                ...
                for (int i = 0; i < arrayListNome.size(); i++) {
                    for (int j = 0; j < arrayListUsuario.size(); j++) {
                        ...
                        for (int h = 0; h < arrayListUsuario.get(j).instrumental.size(); h++) {
                            if (!arrayListNome.get(i).equals(arrayListUsuario.get(j).instrumental.get(h).id)) {
                    ...
                    filtroCron.numero = "Tocou *" + qtd + "* vezes";
    ...
    private void buscarTodosWeb() {
        ...
        String[] todos = {"ebd", "domingo", "quarta", "especial"};
    ...
    public void onItemClick(View view, FiltroCron obj, int pos) {
       // Toast.makeText(getApplicationContext(), Timestamp.getFormatedDateTime(Long.parseLong("1546383965"), "dd/MM/yyyy"), Toast.LENGTH_SHORT).show();
    }
