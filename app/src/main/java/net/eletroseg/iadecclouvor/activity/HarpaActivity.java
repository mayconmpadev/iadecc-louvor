...
public class HarpaActivity extends AppCompatActivity {
    ...
    private SPM spm = new SPM(HarpaActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harpa);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (verificarNaMemoria(arrayListHino.get(cont).nome)) {
                    ...
                    Toast.makeText(getApplicationContext(), "clique no hino para fazer o download", Toast.LENGTH_SHORT).show();
                }
        ...
        mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (cont < arrayListHino.size()) {
                    ...
                    Toast.makeText(getApplicationContext(), Parametro.nome, Toast.LENGTH_SHORT).show();
                    mp.seekTo(0);
                    mp.reset();
                    play();
