...
public class MinistranteEstatisticaActivity extends AppCompatActivity implements AdapterMinistranteEstatistica.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ministrante_estatistica);
        ...
        query.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                for (int i = 0; i < arrayListUsuario.size(); i++) {
                    if (arrayListUsuario.get(i).ministrante.id.equals(usuario.ministrante.id)) {
            ...
            public void onChildRemoved(DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < arrayListUsuario.size(); i++) {
                    if (arrayListUsuario.get(i).ministrante.id.equals(usuario.id)) {
                        arrayListUsuario.remove(i);
                    }
                }
                if (!sPesquisa.equals("")) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < arrayListUsuario.size(); i++) {
                    ...
                    if (!arrayListNome.contains(arrayListUsuario.get(i).ministrante.id)) {
                        arrayListNome.add(arrayListUsuario.get(i).ministrante.id);
                ...
                for (int i = 0; i < arrayListNome.size(); i++) {
                    for (int j = 0; j < arrayListUsuario.size(); j++) {
                        if (!arrayListNome.get(i).equals(arrayListUsuario.get(j).ministrante.id)) {
