...
public class VocalEstatisticaActivity extends AppCompatActivity implements AdapterMinistranteEstatistica.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocal_estatistica);
    ...
    private void buscarClienteWeb(String cominho) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < arrayListUsuario.size(); i++) {
                    for (int j = 0; j < arrayListUsuario.get(i).vocal.size(); j++) {
                        if (!arrayListNome.contains(arrayListUsuario.get(i).vocal.get(j).id)) {
                            arrayListNome.add(arrayListUsuario.get(i).vocal.get(j).id);
                ...
                for (int i = 0; i < arrayListNome.size(); i++) {
                    for (int j = 0; j < arrayListUsuario.size(); j++) {
                        ...
                        for (int h = 0; h < arrayListUsuario.get(j).vocal.size(); h++) {
                            if (!arrayListNome.get(i).equals(arrayListUsuario.get(j).vocal.get(h).id)) {
                    ...
                    filtroCron.numero = "cantou *" + qtd + "* vezes";
